...
//주 생성자 사용 시 주 생성자의 매개변수 사용 및 소스코드를 실행하기 위해서 init코드 블럭을 사용함
...
// 주 생성자의 매개변수에 var, val 키워드를 사용하면 해당 클래스의 멤버 필드로 선언됨
...
//    보조 생성자를 생성자 오버로딩에 의해서 여러 개의 생성자를 사용할 수 있음
    constructor(name:String){
        println("매개변수가 1개인 보조 생성자 호출 : ${name}")
    }
    constructor(name: String,count: Int){
        println("매개변수가 2개인 보조 생성자 호출 : ${name}, ${count}" )
    }
}
// 주 생성자와 보조 생성자를 함께 사용하는 클래스는
// 반드시 보조 생성자에서 주 생성자를 호출 하는 부분이 필요함
...
//    보조 생성자
//    자바의 this() 키워드와 같이 this()가 해당 생성자보다 먼저 실행함
...
//    주 생성자를 사용하여 객체 생성
    ...
    println()
    val user102 = User10("홍길동",102)
    println()
    val user103 = User10("홍길동",103,"fullstack501@bitc.kr")
}
